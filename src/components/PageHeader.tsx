        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          {onSettings && (
            <Pressable
              ...
              className="grid h-11 w-11 place-items-center rounded-full border border-zinc-200/80 bg-white text-zinc-600 shadow-card transition-all duration-200 hover:bg-zinc-50 hover:scale-105 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800"
            >
